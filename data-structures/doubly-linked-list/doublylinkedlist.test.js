...
describe('Doubly LinkedList', () => {
  ...
  it('should prepend data', () => {
    ...
    expect(dlinkedlist.head.next).toBeNull;
    expect(dlinkedlist.tail.value).toBe(5);
    dlinkedlist.prepend(10);
    expect(dlinkedlist.head.value).toBe(10);
    expect(dlinkedlist.head.next.value).toBe(5);
    expect(dlinkedlist.tail.value).toBe(5);
  });
  ...
  it('should delete node on linked list', () => {
    const linkedList = new DoublyLinkedList();
